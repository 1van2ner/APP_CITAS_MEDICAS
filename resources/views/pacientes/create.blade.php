...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 py-8 px-4">
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-blue-900">Crear Paciente</h1>
        </div>
            ...
            <form action="{{ route('pacientes.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="nombre" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ old('nombre') }}">
                        @error('nombre') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                    </div>

                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Apellido</label>
                        <input type="text" name="apellido" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ old('apellido') }}">
                    ...
                    <div>
                        ...
                        <input type="date" name="fecha_nacimiento" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ old('fecha_nacimiento') }}">
                    ...
                    <div>
                        ...
                        <input type="tel" name="telefono" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ old('telefono') }}">
                ...
                <div>
                    ...
                    <input type="text" name="direccion" required class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" value="{{ old('direccion') }}">
